...
void track_selection_redoMC()
{
    ...
    TH1F *data_sigmad0calcrun1 = new TH1F ("data_sigmad0calcrun1", "data #sigma_{xy} calc run 1", 200, 0, 4);
    TH1F *data_d0calcrun1 = new TH1F ("data_d0_calcrun1", "data d_{0} calc run 1", 50, 0, 1);
                    ...
                    if((*nvecdata_vtxndof)[vtxdof] > dof_cut)
                    {
                        ...
                        if (fdata_vtxxysize < vtxxysize && fdata_vtxzsize < vtxzsize)
                        {
                            ...
                            for (int t = 0; t != ndata_totaltrk; ++t)
                            {
                                ...
                                //using formula from paper of run 1 result, dz is leaf calue
