...
//==============================================Variables==============================================================
    ...
    //========================================================= Start of Trk Loop ================================================================
                        ...
                        //======================================= Trk cuts ===================================================
                                    ...
                                    {
                                        if (fabs(data_vec.Eta()) <= eta_cut && (fabs(fdata_d0_sigmad0) < d0_d0Err_cut) && (fabs(fdata_dz_sigmadz) < dz_dzErr_cut) && (fabs(fdata_sigmapt_pt) < ptErr_pt_cut))
                                        {
                                        ...
                                        if (data_vec.Pt() >= pt_cut && (fabs(fdata_sigmapt_pt) < ptErr_pt_cut) && (fabs(fdata_d0_sigmad0) < d0_d0Err_cut) && (fabs(fdata_dz_sigmadz) < dz_dzErr_cut) )
                                        {
                                        ...
                                        {
                                            if((fabs(fdata_d0_sigmad0) < d0_d0Err_cut) && (fabs(fdata_dz_sigmadz) < dz_dzErr_cut))
                                            {
                                                data_sigmapt_pt->Fill(fdata_sigmapt_pt);
                                                ++fdata_trkdpt;
                                            }

                                            if((fabs(fdata_d0_sigmad0) < d0_d0Err_cut) && (fabs(fdata_dz_sigmadz) < dz_dzErr_cut) && (fabs(fdata_sigmapt_pt) < ptErr_pt_cut))
                                            {
                                            ...
                                            if ((fabs(fdata_sigmapt_pt) < ptErr_pt_cut) && (fabs(fdata_dz_sigmadz) < dz_dzErr_cut))
                                            {
        ...
        TFile data_plot("Tests/data_trees.root", "recreate");
        //gStyle->SetOptLogy();
...
//=========================== Define variables to read TTree ================
    ...
    //========================================================= End of Herwig File Loop ================================================================
        ...
        TFile reco_plot("Tests/data_treesCUETP8M1_66.root", "recreate");
        //gStyle->SetOptLogy();
